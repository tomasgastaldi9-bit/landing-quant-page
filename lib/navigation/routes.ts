...
export const navigationRoutes: NavigationRoute[] = [
  ...
  },
  {
    ...
    href: "/execution",
    group: "Operator",
    description: "Read-only operator execution monitor",
    aliases: ["/execution", "execution", "orders", "fills", "order monitor"],
    keywords: ["operator", "execution", "orders", "submitted", "filled", "blocked", "testnet"],
    audience: "operator",
    badge: "READ",
    drawerMicrocopy: "Telemetry",
    isDrawerVisible: true,
  ...
  {
    label: "Demo/Testnet Scope",
    href: "/demo-testnet",
    group: "Operator",
    description: "No real capital, testnet execution, and validation scope",
    aliases: ["testnet", "demo testnet", "demo scope", "execution safety"],
    keywords: ["operator", "demo", "testnet", "no real capital", "validation"],
    audience: "operator",
