      ...
      <div className="relative mx-auto grid min-h-[640px] max-w-7xl grid-cols-1 items-center gap-10 px-4 py-14 sm:px-8 sm:py-16 lg:grid-cols-[1.02fr_0.98fr] lg:py-20">
        <div className="max-w-3xl">
          ...
          <div className="mt-7 flex flex-col gap-3 sm:flex-row">
            ...
            <a
              href="/request-access"
              className="rounded-xl border border-[#424655] bg-[#0a0a0a]/90 px-6 py-3.5 text-center text-sm font-semibold text-white shadow-[0_14px_34px_rgba(0,0,0,0.18)] backdrop-blur-sm transition duration-200 hover:-translate-y-px hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)]"
            >
              Request Access
            </a>
          </div>
