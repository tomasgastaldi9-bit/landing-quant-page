    ...
    >
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-14 sm:px-8 sm:py-[72px] lg:grid-cols-[1fr_auto] lg:items-center">
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
          ...
          <a
            href="/request-access"
            className="rounded-xl border border-[#424655] bg-[#0a0a0a]/90 px-7 py-4 text-center text-sm font-semibold text-[#e2e2e2] shadow-[0_14px_34px_rgba(0,0,0,0.18)] backdrop-blur-sm transition duration-200 hover:-translate-y-px hover:border-[var(--accent-primary)] hover:text-[var(--accent-primary)]"
          >
            Request Access
          </a>
        </div>
